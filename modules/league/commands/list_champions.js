module.exports = {
    ...
    async execute(message, args, extra) {
        var api = extra.api;
        const { EmbedBuilder } = require('discord.js'); // New import for EmbedBuilder
        var respChamps;
        if(args[1]){
            if(args[1].includes("@")){
